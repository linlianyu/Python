...
print('-----这是一条可爱的分割线-----')
path = '/User/linlianyu/github/Python/start/FileOperation/TestFile.py'
...
print('-----这是一条可爱的分割线-----')
print(os.path.getsize('./FileOperation/TestFile.py'))     # 获取文件的字节数
...
print(os.path.isdir('./FileOperation/TestFile.py'))
print(os.path.isfile('.'))      # 判断传入参数是否为文件
print(os.path.isfile('./FileOperation/TestFile.py'))
print('-----这是一条可爱的分割线-----')
file1 = open('./FileOperation/rwFile/OneLineFile.txt', 'r')      # 使用open()函数打开一个文件,模式为'r'(只读)
text1 = file1.read()      # 读取文件中的内容
print(text1)
file2 = open('./FileOperation/rwFile/ManyLineFile.txt', 'r')
text2 = file2.readlines()       # 取得文件每一行文本的列表
print(text2)
file1.close()
file2.close()
print('-----这是一条可爱的分割线-----')
writeFile = open('./FileOperation/rwFile/WriteFile.txt', 'w')        # 写入文本,参数'w'(写入模式)
writeFile.write('Hello')
writeFile = open('./FileOperation/rwFile/WriteFile.txt', 'a')        # 参数'a'(添加模式)
writeFile.write(' 大傻子')
writeFile = open('./FileOperation/rwFile/WriteFile.txt', 'r')
